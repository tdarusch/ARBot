...
weapontable = {'ak-47': ["AK-47", 20, 223, 700, 3, 18.25, 11, "Barrel, Scope", '30, 40, 75'],
               'ak-74': ["AK-74", 17, 184, 650, 2.5, 16.5, 7, "Barrel, Scope", "30, 45, 75"],
               'an-94': ["AN-94", 17, 170, 600, 2.75, 16.75, 12, "Barrel, scope", "30, 45, 75"],
               'akm': ["AKM", 20, 200, 600, 2.75, 16.75, 12, "Barrel, scope", "30, 40, 75"],
               'ak-104': ["AK-104", 20, 200, 600, 2, 17, 11, "Barrel, Underbarrel + Grip, Scope", "30, 40, 75"],
               'ak-12': ["AK-12", 20, 200, 600, 1.75, 19.5, 10, "Barrel, Underbarrel + Grip, Scope", "30, 40, 75"],
               'ots-14': ["OTs-14", 20, 233, 700, 3.25, 16, 10, "Barrel, Scope", "30, 40, 75"],
               'scar-l': ["SCAR-L", 18, 180, 600, 2.25, 17, 8, "Barrel, Underbarrel + Grip, Scope", "30, 50, 100"],
               ...
               'aks-74u': ["AKS-74U", 17, 198, 700, 3.75, 15.5, 8, "Barrel, Scope", "30, 45, 75"],
               'pp-19': ["PP-19", 13, 141, 650, 4, 14.5, 5, "Barrel, Scope", "64"],
               ...
               'db shotgun': ["DB Shotgun", 40, 400, 600, 27.5, 35, 30, "None", "2"],
               'maverick 88': ["Maverick 88", 32, "N/A", 100, 22.5, 27.5, 23, "None", "6"],
               'auto-5': ["Auto-5", 32, 320, 600, 25, 30, 18, "None", "6"],
               'm3': ["M3", 14, 105, 405, 4, 15, 6, "None", "30"],
               'mosin nagant': ["Mosin Nagant", 22, "N/A", 100, 0.75, 18, 15, "None", "5"],
               'lee enfield': ["Lee Enfield", 23, "N/A", 100, 1, 18, 15, "None", "10"],
               'm1 garand': ["M1 Garand", 22, 220, 600, 1.25, 20, 12, "None", "8"],
               ...
               'mk 48': ["MK 48", 22, 257, 700, 3, 26.5, 9, "Underbarrel + Grip, Scope", "100"],
               'hk21': ["HK21", 22, 330, 900, 2.75, 25, 9, "Barrel, Underbarrel + Grip, Scope", "20, 30, 50"],
               'tec-9': ["TEC-9", 14, 175, 750, 5, 17.75, 9, "Barrel", "20, 32"],
               ...
               'cbj-ms': ["CBJ-MS", 14, 163, 700, 3.75, 18, 8, "Barrel, Scope", "20, 32"],
               'g37': ["G37", 19, 190, 600, 4.25, 18.25, 12, "Barrel", "12"],
               'mk 23': ["Mk 23", 19, 190, 600, 4, 18.25, 11, "Barrel", "12"],
               ...
               'cz-75': ["CZ-75", 14, 140, 600, 4.75, 17, 9, "Barrel, Underbarrel", "12"],
               'model 459': ["Model 459", 14, 140, 600, 4.75, 17.75, 8, "Barrel, Underbarrel", "14"],
               }
            ...
            if any(string in comment.body for string in weapontable):
                ...
                for z in weapontable:
                    if z in body and z not in weapons:
                        weapons.append(str(z))
                for v in meleetable:
                    if v in body and v not in melees:
                        melees.append(str(v))
                if len(weapons) > 1:
                    for m in weapons:
                        sort(m)
